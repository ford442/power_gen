...
export const solarSyncAfterPhysics: NonNullable<DevicePlugin['syncAfterPhysics']> = (instance, ctx) => {
...
export const solarComputeRawEnergy: NonNullable<DevicePlugin['computeRawEnergy']> = (instance, ctx) => {
...
export const solarBuildUniformExtras: NonNullable<DevicePlugin['buildUniformExtras']> = (instance) => {
  return {
...
export const solarUpdateFlowPaths: NonNullable<DevicePlugin['updateFlowPaths']> = (instance, ctx) => {
...
export const solarUpdateEffects: NonNullable<DevicePlugin['updateEffects']> = (instance, ctx) => {
