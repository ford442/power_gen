...
function snapFromPhysics(
  ...
  return {
    ...
    peltierHotK: physics.peltierHotK ?? 0,
    peltierColdK: physics.peltierColdK ?? 0,
    peltierDeltaT: physics.peltierDeltaT ?? 0,
    peltierVoltage: physics.peltierVoltage ?? 0,
    peltierCurrent: physics.peltierCurrent ?? 0,
    peltierPowerW: physics.peltierPowerW ?? 0,
    peltierCOP: physics.peltierCOP ?? 0,
    mhdFlowU: physics.mhdFlowU ?? 0,
    mhdBFieldT: physics.mhdBFieldT ?? 0,
    mhdHartmann: physics.mhdHartmann ?? 0,
    mhdVoltage: physics.mhdVoltage ?? 0,
    mhdCurrent: physics.mhdCurrent ?? 0,
    mhdPowerW: physics.mhdPowerW ?? 0,
    transformerVp: physics.transformerVp ?? 0,
    transformerVs: physics.transformerVs ?? 0,
    transformerIpA: physics.transformerIpA ?? 0,
    transformerIsA: physics.transformerIsA ?? 0,
    transformerK: physics.transformerK ?? 0,
    transformerFluxN: physics.transformerFluxN ?? 0,
    vdgVoltage: physics.vdgVoltage ?? 0,
    vdgBeltMps: physics.vdgBeltMps ?? 0,
    vdgChargeC: physics.vdgChargeC ?? 0,
    vdgSparkHz: physics.vdgSparkHz ?? 0,
    hallVoltage: physics.hallVoltage ?? 0,
    hallCurrent: physics.hallCurrent ?? 0,
    hallFieldT: physics.hallFieldT ?? 0,
    hallCoeff: physics.hallCoeff ?? 0,
    lorentzSledVms: physics.lorentzSledVms ?? 0,
    lorentzCurrentA: physics.lorentzCurrentA ?? 0,
