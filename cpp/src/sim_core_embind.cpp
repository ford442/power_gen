...
EMSCRIPTEN_BINDINGS(sim_core) {
    ...
    class_<SEGSimulator>("SEGSimulator")
        ...
        .function("getLorentzForceN", &SEGSimulator::getLorentzForceN)
        .function("getLorentzPositionM", &SEGSimulator::getLorentzPositionM)
        .function("setLorentzFieldT", &SEGSimulator::setLorentzFieldT)
        .function("getRingHeightM", &SEGSimulator::getRingHeightM)
        .function("getRingCurrentA", &SEGSimulator::getRingCurrentA)
        .function("getRingPrimaryIA", &SEGSimulator::getRingPrimaryIA)
        .function("getRingForceN", &SEGSimulator::getRingForceN)
        .function("getRingCouplingK", &SEGSimulator::getRingCouplingK)
        .function("getRingVelocityMps", &SEGSimulator::getRingVelocityMps)
